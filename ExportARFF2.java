...
public class ExportARFF2 {
	...
	public static void main (String [] args) throws Exception {
		...
		int steppingStone;
		//BufferedWriter bwa = new BufferedWriter(new FileWriter("ContinuingNewsIDs1.txt"));
				...
				try
				{
					...
					while ((line = br.readLine())!=null) {
						...
						if (foundFlood)
						{
							...
							{
								if (!continuingNewsID.contains(possibleID))
		...
		for (steppingStone = 0; steppingStone < 2; steppingStone++)
		{
			...
			/*
			 case 0: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			 */
			switch (steppingStone)
			{
			//case 0: files2 = new String[] {"2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
			//		"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
			//		"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
			//		"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 0: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2013_Boston_bombings.json.gz","2013_Australia_bushfire.json.gz"}; break;
			case 1: files2 = new String[] {"2012_Philipinnes_floods.json.gz"}; break;
			case 2: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 3: files2 = new String[] {"2012_Guatemala_earthquake.json.gz"}; break;
			case 4: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 5: files2 = new String[] {"2012_Italy_earthquakes.json.gz"}; break;
			case 6: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 7: files2 = new String[] {"2012_Philipinnes_floods.json.gz"}; break;
			case 8: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 9: files2 = new String[] {"2013_Alberta_floods.json.gz"}; break;
			case 10: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 11: files2 = new String[] {"2013_Australia_bushfire.json.gz"}; break;
			case 12: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 13: files2 = new String[] {"2013_Boston_bombings.json.gz"}; break;
			case 14: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 15: files2 = new String[] {"2013_Manila_floods.json.gz"}; break;
			case 16: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 17: files2 = new String[] {"2013_Queensland_floods.json.gz"}; break;
			case 18: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 19: files2 = new String[] {"2013_Typhoon_Yolanda.json.gz"}; break;
			case 20: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 21: files2 = new String[] {"2014_Chile_Earthquake.json.gz"}; break;
			case 22: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 23: files2 = new String[] {"2014_Typhoon_Hagupit.json.gz"}; break;
			case 24: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Paris_Attacks.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 25: files2 = new String[] {"2015_Nepal_Earthquake.json.gz"}; break;
			case 26: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2018_FL_School_Shooting.json.gz"}; break;
			case 27: files2 = new String[] {"2015_Paris_Attacks.json.gz"}; break;
			case 28: files2 = new String[] {"2011_Joplin_tornado.json.gz","2012_Guatemala_earthquake.json.gz","2012_Italy_earthquakes.json.gz",
					"2012_Philipinnes_floods.json.gz","2013_Alberta_floods.json.gz","2013_Australia_bushfire.json.gz","2013_Boston_bombings.json.gz",
					"2013_Manila_floods.json.gz","2013_Queensland_floods.json.gz","2013_Typhoon_Yolanda.json.gz","2014_Chile_Earthquake.json.gz",
					"2014_Typhoon_Hagupit.json.gz","2015_Nepal_Earthquake.json.gz","2015_Paris_Attacks.json.gz"}; break;
		...
		*/
		...
		{
			System.out.println("Writing. Stepping Stone No." + steppingStone);
			try {
				...
				switch (steppingStone)
				{
				case 0: whatToWrite = "2011PhilTrainLong.arff"; break;
				case 1: whatToWrite = "2012GuatemalaTrain.arff"; break;
				case 2: whatToWrite = "2012ItalyTrain.arff"; break;
				case 3: whatToWrite = "2012PhilippineTrain.arff"; break;
				...
				for (int thearffs = 0; thearffs < 15; thearffs++)
				{
				...
				for (int searchThrough = 0; searchThrough < 15; searchThrough++)
				{
					if (!firstTimeDone)
					{
				...
				*/
				...
				for (int i = 0; i < arffListComplete.get(liveCount).size(); i++) {		
					bw.write("{");
					...
					for (int j = 0; j < arffListComplete.get(liveCount).get(i).size() - 4; j++)
					{						
						int no = (int) arffListComplete.get(liveCount).get(i).get(j);						
					...
					if (arffListComplete.get(liveCount).get(i).get(arffListComplete.get(liveCount).get(i).size() - 4).equals("verified"))
						bw.write(String.valueOf(lexiconList.size()) + "\t" + "1.0," + "\t");

					if (arffListComplete.get(liveCount).get(i).get(arffListComplete.get(liveCount).get(i).size() - 3).equals("hasmedia"))
						bw.write(String.valueOf(lexiconList.size() + 1) + "\t" + "1.0," + "\t");

					if (arffListComplete.get(liveCount).get(i).get(arffListComplete.get(liveCount).get(i).size() - 2).equals("desc"))
						bw.write(String.valueOf(lexiconList.size() + 2) + "\t" + "1.0," + "\t");

					bw.write(String.valueOf(lexiconList.size() + 3));
					bw.write("\t");

					if (arffListComplete.get(liveCount).get(i).get(arffListComplete.get(liveCount).get(i).size() - 1) == "continuingnews")
				...
				switch (steppingStone)
				{
				case 0: whatToWrite = "2011PhilTestLong.arff"; break;
				case 1: whatToWrite = "2012GuatemalaTest.arff"; break;
				case 2: whatToWrite = "2012ItalyTest.arff"; break;
				case 3: whatToWrite = "2012PhilippineTest.arff"; break;
